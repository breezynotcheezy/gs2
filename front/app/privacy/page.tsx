  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black text-amber-50">
      <main className="container mx-auto px-4 py-10 max-w-3xl">
        ...
        <p className="text-sm text-gray-400 mb-6">Last updated: 2025-09-19</p>

        <section className="space-y-3 mb-8">
          <h2 className="text-xl font-mono font-semibold">Information We Collect</h2>
          <p className="text-gray-300">We collect only the minimum information required to provide the service, such as play-by-play text you upload to run analytics.</p>
        </section>

        <section className="space-y-3 mb-8">
          <h2 className="text-xl font-mono font-semibold">How We Use Information</h2>
          <p className="text-gray-300">Uploaded text is processed to derive analytics. We may store anonymized, aggregated metrics to improve quality and reliability.</p>
        </section>
        ...
        <section className="space-y-3 mb-8">
          ...
          <p className="text-gray-300">For any inquiries, contact: cgreen39@gmu.edu</p>
        </section>
      </main>
    </div>
  )
